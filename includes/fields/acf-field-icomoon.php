	...
	class ViiVue_ACF_Field_Icomoon extends acf_field{
		...
		function render_field_settings($field){
			...
			acf_render_field_setting($field, [
				...
				'instructions' => __('The path to the selection.json file generated by IcoMoon. Default: [your-theme]/assets/fonts/selection.json. Falls back to plugin’s default if not found.', 'acf-icomoon'),
				'type'         => 'text',
